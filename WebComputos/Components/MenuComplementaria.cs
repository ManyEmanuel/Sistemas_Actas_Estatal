...
{
    public class MenuComplementaria : ViewComponent
    {
        private readonly IContenedorTrabajo _ctx;
        private readonly UserManager<T_Usuario> _userManager;

        public MenuComplementaria(IContenedorTrabajo ctx, UserManager<T_Usuario> userManager)
        {
            _ctx = ctx;
        ...
        public IViewComponentResult Invoke()
        {
            ...
            ViewBag.ComprobarDipRP = _ctx.Acta.ComprobarDipRP(Oficina.MunicipioId);
            ViewBag.ComprobarRegRP = _ctx.Acta.ComprobarRegRP(Oficina.MunicipioId);
            ViewBag.DiputacionRP = _ctx.Acta.ListaSeccionInfoComByMunicipioDipRP(Oficina.MunicipioId);
            ViewBag.RegiduriaRP = _ctx.Acta.ListaSeccionInfoComByMunicipioRegRP(Oficina.MunicipioId);
            return View(Munu);
        }
    }
}
