            ...
            { "data": "idr", "width": "10%", "visible": false },
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                            ...
                            &nbsp;
                             <a href='/Admin/TRecepcionPaquetes/ImprimirDetalle/${data}' target='_blank' class='btn btn-warning text-white' style='cursor:pointer; width:120px;' >
                            <i class='fas fa-print'></i> Modificar
                            </a>
                            </div>`;
                }, "width": "40%"
            }
